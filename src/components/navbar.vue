    ...
    <div class="container">
      <nav class="navbar px-0 py-1 text-14 navbar-expand-lg navbar-light">
        <router-link :to="{ name: 'home' }" class="navbar-brand text-22 d-flex align-items-center antialiased">
          <img class="mr-2 avatar-40" src="/yike.svg" alt="开发者联盟">开盟<span class="text-14 text-muted ml-1">| 开发者联盟社区</span><sup class="ml-1 text-10 text-danger"> Beta</sup> </router-link>
